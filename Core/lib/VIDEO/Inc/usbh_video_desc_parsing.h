...
USBH_StatusTypeDef ParseCSDescriptors(VIDEO_ClassSpecificDescTypedef *class_desc, uint8_t ac_subclass, uint8_t *pdesc);
...
extern uint32_t USBH_VIDEO_Best_dwDefaultFrameInterval;
#endif
